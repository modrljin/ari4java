...
public class ActionAsterisk_impl_ari_4_0_0 extends BaseAriAction  implements ActionAsterisk {
/**********************************************************
...
return deserializeJsonAsAbstractList( json,
   new TypeReference<List<ConfigTuple_impl_ari_4_0_0>>() {} ); 
}

@Override
public void getObject(String configClass, String objectType, String id, AriCallback<List<ConfigTuple>> callback) {
buildGetObject(configClass, objectType, id);
httpActionAsync(callback, new TypeReference<List<ConfigTuple_impl_ari_4_0_0>>() {});
}
...
buildGetInfo(only);
String json = httpActionSync();
return deserializeJson( json, AsteriskInfo_impl_ari_4_0_0.class ); 
}

@Override
public void getInfo(String only, AriCallback<AsteriskInfo> callback) {
buildGetInfo(only);
httpActionAsync(callback, AsteriskInfo_impl_ari_4_0_0.class);
}
...
String json = httpActionSync();
return deserializeJsonAsAbstractList( json,
   new TypeReference<List<LogChannel_impl_ari_4_0_0>>() {} ); 
}

@Override
public void listLogChannels(AriCallback<List<LogChannel>> callback) {
buildListLogChannels();
httpActionAsync(callback, new TypeReference<List<LogChannel_impl_ari_4_0_0>>() {});
}
...
String json = httpActionSync();
return deserializeJsonAsAbstractList( json,
   new TypeReference<List<Module_impl_ari_4_0_0>>() {} ); 
}

@Override
public void listModules(AriCallback<List<Module>> callback) {
buildListModules();
httpActionAsync(callback, new TypeReference<List<Module_impl_ari_4_0_0>>() {});
}
...
String json = httpActionSync();
return deserializeJson( json, Module_impl_ari_4_0_0.class ); 
}

@Override
public void getModule(String moduleName, AriCallback<Module> callback) {
buildGetModule(moduleName);
httpActionAsync(callback, Module_impl_ari_4_0_0.class);
}
...
buildPing();
String json = httpActionSync();
return deserializeJson( json, AsteriskPing_impl_ari_4_0_0.class ); 
}

@Override
public void ping(AriCallback<AsteriskPing> callback) {
buildPing();
httpActionAsync(callback, AsteriskPing_impl_ari_4_0_0.class);
}
...
String json = httpActionSync();
return deserializeJson( json, Variable_impl_ari_4_0_0.class ); 
}

@Override
public void getGlobalVar(String variable, AriCallback<Variable> callback) {
buildGetGlobalVar(variable);
httpActionAsync(callback, Variable_impl_ari_4_0_0.class);
}
