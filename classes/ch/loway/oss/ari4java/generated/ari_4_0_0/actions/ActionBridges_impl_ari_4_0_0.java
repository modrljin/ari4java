...
public class ActionBridges_impl_ari_4_0_0 extends BaseAriAction  implements ActionBridges {
/**********************************************************
 * Active bridges
 * 
...
return deserializeJsonAsAbstractList( json,
   new TypeReference<List<Bridge_impl_ari_4_0_0>>() {} ); 
}

@Override
public void list(AriCallback<List<Bridge>> callback) {
buildList();
httpActionAsync(callback, new TypeReference<List<Bridge_impl_ari_4_0_0>>() {});
}
...
String json = httpActionSync();
return deserializeJson( json, Bridge_impl_ari_4_0_0.class ); 
}

@Override
public void create(String type, String bridgeId, String name, AriCallback<Bridge> callback) {
buildCreate(type, bridgeId, name);
httpActionAsync(callback, Bridge_impl_ari_4_0_0.class);
}
