...
public class ActionChannels_impl_ari_4_0_0 extends BaseAriAction  implements ActionChannels {
/**********************************************************
 * Active channels
 * 
...
return deserializeJsonAsAbstractList( json,
   new TypeReference<List<Channel_impl_ari_4_0_0>>() {} ); 
}

@Override
public void list(AriCallback<List<Channel>> callback) {
buildList();
httpActionAsync(callback, new TypeReference<List<Channel_impl_ari_4_0_0>>() {});
}
...
String json = httpActionSync();
return deserializeJson( json, Channel_impl_ari_4_0_0.class ); 
}
...
buildOriginate(endpoint, extension, context, priority, label, app, appArgs, callerId, timeout, variables, channelId, otherChannelId, originator, formats);
httpActionAsync(callback, Channel_impl_ari_4_0_0.class);
}
...
String json = httpActionSync();
return deserializeJson( json, Playback_impl_ari_4_0_0.class ); 
}
...
buildPlay(channelId, media, lang, offsetms, skipms, playbackId);
httpActionAsync(callback, Playback_impl_ari_4_0_0.class);
}
...
String json = httpActionSync();
return deserializeJson( json, LiveRecording_impl_ari_4_0_0.class ); 
}
...
buildRecord(channelId, name, format, maxDurationSeconds, maxSilenceSeconds, ifExists, beep, terminateOn);
httpActionAsync(callback, LiveRecording_impl_ari_4_0_0.class);
}
...
String json = httpActionSync();
return deserializeJson( json, RTPstat_impl_ari_4_0_0.class ); 
}

@Override
public void rtpstatistics(String channelId, AriCallback<RTPstat> callback) {
buildRtpstatistics(channelId);
httpActionAsync(callback, RTPstat_impl_ari_4_0_0.class);
}
