...
public class ActionRecordings_impl_ari_4_0_0 extends BaseAriAction  implements ActionRecordings {
/**********************************************************
...
return deserializeJsonAsAbstractList( json,
   new TypeReference<List<StoredRecording_impl_ari_4_0_0>>() {} ); 
}

@Override
public void listStored(AriCallback<List<StoredRecording>> callback) {
buildListStored();
httpActionAsync(callback, new TypeReference<List<StoredRecording_impl_ari_4_0_0>>() {});
}
...
String json = httpActionSync();
return deserializeJson( json, StoredRecording_impl_ari_4_0_0.class ); 
}

@Override
public void getStored(String recordingName, AriCallback<StoredRecording> callback) {
buildGetStored(recordingName);
httpActionAsync(callback, StoredRecording_impl_ari_4_0_0.class);
}
