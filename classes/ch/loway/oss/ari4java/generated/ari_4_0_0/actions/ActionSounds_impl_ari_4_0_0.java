...
public class ActionSounds_impl_ari_4_0_0 extends BaseAriAction  implements ActionSounds {
/**********************************************************
 * Sounds
 * 
 * List all sounds.
...
return deserializeJsonAsAbstractList( json,
   new TypeReference<List<Sound_impl_ari_4_0_0>>() {} ); 
}

@Override
public void list(String lang, String format, AriCallback<List<Sound>> callback) {
buildList(lang, format);
httpActionAsync(callback, new TypeReference<List<Sound_impl_ari_4_0_0>>() {});
}
...
buildGet(soundId);
String json = httpActionSync();
return deserializeJson( json, Sound_impl_ari_4_0_0.class ); 
}

@Override
public void get(String soundId, AriCallback<Sound> callback) {
buildGet(soundId);
httpActionAsync(callback, Sound_impl_ari_4_0_0.class);
}
