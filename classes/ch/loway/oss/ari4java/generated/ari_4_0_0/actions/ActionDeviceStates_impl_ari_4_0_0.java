...
public class ActionDeviceStates_impl_ari_4_0_0 extends BaseAriAction  implements ActionDeviceStates {
/**********************************************************
 * Device states
 * 
...
return deserializeJsonAsAbstractList( json,
   new TypeReference<List<DeviceState_impl_ari_4_0_0>>() {} ); 
}

@Override
public void list(AriCallback<List<DeviceState>> callback) {
buildList();
httpActionAsync(callback, new TypeReference<List<DeviceState_impl_ari_4_0_0>>() {});
}
...
buildGet(deviceName);
String json = httpActionSync();
return deserializeJson( json, DeviceState_impl_ari_4_0_0.class ); 
}

@Override
public void get(String deviceName, AriCallback<DeviceState> callback) {
buildGet(deviceName);
httpActionAsync(callback, DeviceState_impl_ari_4_0_0.class);
}
